  ...
  return (
    <div className="relative">
      <motion.div
        ...
        className="absolute top-2 bottom-2 left-[7px] w-px origin-top bg-gradient-to-b from-accent/40 to-transparent"
      />
  ...
  return (
    <Reveal>
      <div className="rounded-3xl border border-line bg-card p-8 sm:p-10">
        ...
        <p className="mt-2 font-serif text-lg text-muted italic">{research.subtitle}</p>
